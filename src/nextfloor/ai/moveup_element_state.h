/**
 *  @file moveup_element_state.h
 *  @brief MoveElementState class header
...
/**
 *  @class MoveUpElementState
 *  @brief Concrete class for Move Movement State
 */
class MoveUpElementState : public ElementState {

public:
    MoveUpElementState(nextfloor::element::FSM* owner) : owner_(owner) {}

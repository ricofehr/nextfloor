            ...
            int Fps(double &last_time, int &nb_frames)
            {
                ...
                if (current_time - last_time >= 1.0) {
                    ...
                    if (debug == ConfigEngine::kDEBUG_PERF || debug == ConfigEngine::kDEBUG_ALL) {
                        ...
                        std::cout << sUniverse->countObjects(false) << " objects (" << sUniverse->countObjects(true) << " displayed) in ";
                    ...
                    if (debug == ConfigEngine::kDEBUG_TEST) {
                        ...
                        std::cout << sUniverse->countObjects(true) << ":" << sUniverse->countMovingObjects(true) << std::endl;
                    }
